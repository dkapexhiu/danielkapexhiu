...
const Work = ({ children, offset }) => (
  <>
    <Divider bg="cornflowerblue" clipPath="polygon(0 30%, 100% 20%, 100% 50%, 0 30%)" speed={0.2} offset={offset} />
    <Divider speed={0.1} offset={offset}>
      <UpDown>
        <SVG icon="triangle" hiddenMobile width={6} fill={colors.blue} left="50%" top="75%" />
        <SVG icon="upDown" hiddenMobile width={8} fill={colors['grey-darkest']} left="70%" top="20%" />
        <SVG icon="arrowUp" width={8} stroke={colors['grey-darkest']} left="25%" top="5%" />
